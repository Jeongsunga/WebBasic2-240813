package com.jsa.springbasic.provider;
...
public class JwtProvider {
    ...
    // - @Value()를 이용하여 값을 가져옴
    // - 주의사항 : application.properties / application.yam1을 .gitignore에 등록해야 함
    @Value("${jwt.secret}")
    ...
    public String create(String name){
        ...
        // 비밀키 생성
        // String secretKey = "qwertyuiopesdfghjkl123456789012345678901234567890";
