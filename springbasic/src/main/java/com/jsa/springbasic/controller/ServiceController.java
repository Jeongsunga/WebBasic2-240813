...
import com.jsa.springbasic.service.BasicService;
...
public class ServiceController {
    ...
    // - spring framework에서 권장하고 있는 의존성 주입 방법은 생성자를 통한 의존성 주입
    // - (의존성이 주입되지 않은 상태가 존재할 수 없기 때문이다.)
    ...
    // 생성자를 통한 의존성 주입 방식에는 @Autowired를 걸어줄 필요가 없다.
    // 생성자는 Lombok으로 대체 가능
    // @Autowired
