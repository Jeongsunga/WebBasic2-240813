...
export default function HookComponent2() {
    // useRef
    // - 랜더링 작업없이 값을 기억하고 변경하고자 할 때 사용
    // - DOM 요소를 참조하기 위해 자주 사용
    // - const 변수 = useRef<타입>(초기값);

    // COM 요소를 참조하기 위해 useRef 사용할 경우 참조할 요소의 ref 속성에 참조 변수를 지정해야 함
    ...
    const onButtonClickHandler = () => {
        ...
        // 특정 객체에서 속성 및 메서드를 호출해야 할 때 변수의 값이 null 혹은 undefined가 아닌 상태에서만  
        // 작업을 수행하도록 하려면 변수?.속성 or 변수?.메서드()로 지정
