...
export default function PathMove() {
    ...
    // - 외부 페이지로 이동하고자 할 땐 a 요소 사용해야 함
    // - 컴포넌트 클릭 시 다른 작업을 같이 수행한다면 해당 작업이 정상적으로 완료되지 않을 수 있음
    // - 특정 작업 결과에 따라 다른 경로로 이동하고 싶을 때 <Link> 컴포넌트 사용할 수 없음
    const onClick = () => {
  ...
  return (
    <div>
        ...
        <Link to='/component' onClick={onClick}>링크 컴포넌트</Link><br />
        <button onClick={onLocationHref}>location.href</button><br />
